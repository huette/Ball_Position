========================================================================
    KONSOLENANWENDUNG: Ball_Position-Projektübersicht
========================================================================

Diese Ball_Position-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Ball_Position-Anwendung besteht.


Ball_Position.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Ball_Position.pch und eine 
